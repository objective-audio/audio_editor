//
//  time_numbers_presenter_utils_tests.mm
//

#import <XCTest/XCTest.h>
#include <ae-core/project_editing/features/timing.h>
#include <ae-core/ui_base/features/time/time_numbers_presenter/time_numbers_presenter_utils.h>

using namespace yas;
using namespace yas::ae;

@interface time_numbers_presenter_utils_tests : XCTestCase

@end

@implementation time_numbers_presenter_utils_tests
