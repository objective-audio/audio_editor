...
std::shared_ptr<app_lifetime> app_lifetime::make_shared() {
    ...
    return std::make_shared<app_lifetime>(
        ...
        ae::color::make_shared(), uuid_generator::make_shared(), id_generator::make_shared(), window_lifecycle,
        app_modal_lifecycle::make_shared(), ui_root_lifecycle::make_shared(),
