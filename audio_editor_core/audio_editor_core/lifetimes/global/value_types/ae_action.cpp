...
std::set<module_index> const &action::module_index_set_value() const {
    return std::get<std::set<module_index>>(this->value.value());
}
...
std::set<marker_index> const &action::marker_index_set_value() const {
