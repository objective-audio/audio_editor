...
deselector::deselector(selected_file_module_pool *selected_file_module_pool, selected_marker_pool *selected_marker_pool)
    : _selected_file_module_pool(selected_file_module_pool), _selected_marker_pool(selected_marker_pool) {
}
