...
struct file_module_loader final : std::enable_shared_from_this<file_module_loader> {
    ...
    file_module_loader(project_id const &, project_url const *, project_format const &, file_importer *,
                       file_info_loader const *, player *, file_module_loading_state_holder *, database *, file_track *,
                       edge_holder *, timeline_holder const *);
