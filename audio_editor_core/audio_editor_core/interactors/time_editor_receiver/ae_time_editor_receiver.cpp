...
std::shared_ptr<time_editor_receiver> time_editor_receiver::make_shared(project_id const &project_id,
    ...
    return std::make_shared<time_editor_receiver>(project_id, editor, closer);
}

time_editor_receiver::time_editor_receiver(project_id const &project_id, time_editor *editor,
                                           time_editor_closer *closer)
