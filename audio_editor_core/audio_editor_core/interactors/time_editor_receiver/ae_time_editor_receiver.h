...
struct time_editor_receiver : action_receivable {
    [[nodiscard]] static std::shared_ptr<time_editor_receiver> make_shared(project_id const &, time_editor *,
                                                                           time_editor_closer *);

    time_editor_receiver(project_id const &, time_editor *, time_editor_closer *);
