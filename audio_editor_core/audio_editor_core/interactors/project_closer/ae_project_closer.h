...
struct project_closer final {
    [[nodiscard]] static std::shared_ptr<project_closer> make_shared(window_lifetime_id const &,
                                                                     file_importer_for_project_closer *,
                                                                     window_lifecycle_for_project_closer *,
                                                                     project_state_holder_for_project_closer *);

    project_closer(window_lifetime_id const &, file_importer_for_project_closer *,
