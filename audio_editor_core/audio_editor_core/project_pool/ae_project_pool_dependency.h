...
struct project_for_project_pool : project_for_window_presenter,
    ...
    [[nodiscard]] virtual std::shared_ptr<context_menu_presenter> const &context_menu_presenter() const = 0;
    [[nodiscard]] virtual std::shared_ptr<ae::action_router> const &action_router() const = 0;
