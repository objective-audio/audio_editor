...
struct project_pool final : project_pool_for_app_presenter {
    ...
    static std::shared_ptr<project_pool> make_shared(std::shared_ptr<uuid_generator_for_project_pool> const &);

   private:
    std::shared_ptr<uuid_generator_for_project_pool> const _uuid_generator;
    ...
    project_pool(std::shared_ptr<uuid_generator_for_project_pool> const &);
