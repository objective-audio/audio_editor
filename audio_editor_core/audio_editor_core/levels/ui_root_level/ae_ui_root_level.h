...
struct ui_root_level {
    ...
    ui_root_level(std::shared_ptr<ui::standard> const &, ui_project_id const &project_id,
                  ...
                  std::shared_ptr<ui_mesh_data> const &vertical_line_data, std::shared_ptr<ae::display_space> const &,
                  std::shared_ptr<ui_module_waveforms> const &, std::shared_ptr<ui_modules> const &,
