...
struct project_editor_for_editing_root_presenter {
    ...
    [[nodiscard]] virtual timing_fragment timing_fragment() const = 0;
    ...
    [[nodiscard]] virtual observing::syncable observe_timing_fragment(
        std::function<void(ae::timing_fragment const &)> &&) = 0;
};
}  // namespace yas::ae
