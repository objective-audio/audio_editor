...
namespace yas::ae {
static app_presenter_event_type to_presenter_event_type(project_level_pool_event_type const &type) {
    switch (type) {
        case project_level_pool_event_type::inserted:
            return app_presenter_event_type::make_and_show_window_controller;
        case project_level_pool_event_type::erased:
