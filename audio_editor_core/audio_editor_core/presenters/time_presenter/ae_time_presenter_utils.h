...
#include <audio_editor_core/ae_time_presenter_types.h>

#include <string>

namespace yas::ae::time_presenter_utils {
time_components time_components(frame_index_t const frame, std::shared_ptr<timing_for_time_presenter> const &);
