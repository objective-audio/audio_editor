...
struct edge_presenter final {
    ...
    [[nodiscard]] static std::shared_ptr<edge_presenter> make_shared(
        file_info const &, std::shared_ptr<project_editor_for_edge_presenter> const &,
        std::shared_ptr<display_space> const &);
   ...
   private:
    ...
    edge_presenter(file_info const &, std::shared_ptr<project_editor_for_edge_presenter> const &,
                   std::shared_ptr<display_space> const &);
