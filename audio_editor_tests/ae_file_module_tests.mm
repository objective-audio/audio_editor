...
- (void)test_head_dropped {
    ...
    XCTAssertTrue(module.head_dropped(2).value().is_equal_location(file_module{{}, "", {2, 2}, 11, "test-name-1"}));
    XCTAssertEqual(module.head_dropped(2).value().name, "head_dropped_name");
    XCTAssertTrue(module.head_dropped(3).value().is_equal_location(file_module{{}, "", {3, 1}, 12, "test-name-1"}));
...
- (void)test_tail_dropped {
    ...
    XCTAssertTrue(module.tail_dropped(2).value().is_equal_location(file_module{{}, "", {1, 1}, 10, "test-name-2"}));
    XCTAssertEqual(module.tail_dropped(2).value().name, "tail_dropped_name");
    XCTAssertTrue(module.tail_dropped(3).value().is_equal_location(file_module{{}, "", {1, 2}, 10, "test-name-2"}));
...
- (void)test_offset {
    ...
    XCTAssertTrue(module.offset(-1).is_equal_location(file_module{{}, "", {0, 3}, 10, "test-name-3"}));
    XCTAssertEqual(module.offset(-1).name, "offset_name");
    XCTAssertTrue(module.offset(0).is_equal_location(file_module{{}, "", {1, 3}, 10, "test-name-3"}));
    XCTAssertEqual(module.offset(0).name, "offset_name");
    XCTAssertTrue(module.offset(1).is_equal_location(file_module{{}, "", {2, 3}, 10, "test-name-3"}));
    XCTAssertEqual(module.offset(1).name, "offset_name");
}
