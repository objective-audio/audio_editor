...
- (void)test_head_dropped {
    file_module_object const module{db::make_temporary_id(), "head_dropped_name", {1, 3}, 10, "test-name-1"};
...
- (void)test_tail_dropped {
    file_module_object const module{db::make_temporary_id(), "tail_dropped_name", {1, 3}, 10, "test-name-2"};
...
- (void)test_offset {
    file_module_object const module{db::make_temporary_id(), "offset_name", {1, 3}, 10, "test-name-3"};
