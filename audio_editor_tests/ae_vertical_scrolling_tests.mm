//
//  ae_vertical_scrolling_tests.mm
//
...
@interface ae_vertical_scrolling_tests : XCTestCase

@end

@implementation ae_vertical_scrolling_tests
...
- (void)test_track {
    ...
    XCTAssertEqual(scrolling->track(), 0.0);
    XCTAssertEqual(received.size(), 1);
    XCTAssertEqual(received.at(0), 0.0);

    scrolling->set_delta_track(1.0);
    ...
    XCTAssertEqual(scrolling->track(), 1.0);
    XCTAssertEqual(received.size(), 2);
    XCTAssertEqual(received.at(1), 1.0);

    scrolling->set_delta_track(1.0);

    XCTAssertEqual(scrolling->track(), 2.0);
    XCTAssertEqual(received.size(), 3);
    XCTAssertEqual(received.at(2), 2.0);
