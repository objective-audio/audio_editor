...
- (void)test_insert {
    ...
    auto const index0 = pool->insert_marker(0);
    ...
    auto const index1 = pool->insert_marker(1);
...
- (void)test_observe {
    ...
    // nameだけを変更
    pool->update_marker(index_1, {id_1, {1, "1b"}});
    ...
    // frameだけを変更
    pool->update_marker(index_1, {id_1, {10, "1b"}});
