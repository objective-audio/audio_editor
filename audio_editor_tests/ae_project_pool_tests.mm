...
struct project_stub final : project_for_project_pool {
    ...
    std::shared_ptr<zooming_for_project> const &vertical_zooming() const override {
        static std::shared_ptr<zooming_for_project> const _value = nullptr;
        return _value;
    }
    ...
    std::shared_ptr<ae::action_controller> const &action_controller() const override {
        static std::shared_ptr<ae::action_controller> const _value = nullptr;
        return _value;
    }
